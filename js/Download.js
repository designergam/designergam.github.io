...
//Escrever a pagina de download com array   
    ...
    let cpu_B =  window.document.getElementById("Requisitos") 
        cpu_B.innerText = cpu_A 
    let trailer_B =  window.document.getElementById("trailer")
        trailer_B.src = `https://www.youtube.com/embed/`+Trailer+``
...
//Imagem e Gif, fecha o container se nao tiver nada
...
//Meta Tags e SEO
    ...
    let ogImage = document.getElementById("ogImage")
        ogImage.content=``+conteudo[0].Capa+``

    let ogDescription = document.getElementById("ogDescription")
        ogDescription.content=` Download Grátis de via Torrent`
